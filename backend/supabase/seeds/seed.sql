INSERT INTO videos (id, title, description, hls_url, thumbnail_url, genre, is_mandatory) VALUES
('67ae997e-9b26-46f0-a8bc-9a4bd34c2b17', 'Test Video 1', 'This is a sample video for testing purposes.', 'output_video.m3u8', 'thumbnail.png', 'test', false),
('78ae997e-9b26-46f0-a8bc-9a4bd34c2b17', 'SCOUTs Journey', 'This is a short film with 3d animation.', 'stream_0/playlist.m3u8', 'thumbnail.png', 'short film', true),
('89ae997e-9b26-46f0-a8bc-9a4bd34c2b17', 'OBS Recording Test', 'This is a short clip of me playing Solitaire with multiple Audiotracks', 'stream_0/playlist.m3u8', 'thumbnail.png', 'gaming', false);
