const dePages = {
    ...
    videoManagement: {
        ...
        inviteActive: 'Upload per persönlichem Link ist aktiv. Anzeige und Löschen bleiben nur für Admins sichtbar.',
        ...
        rawHint: 'Lädt Originaldateien in den Bucket user_uploads. Es werden keine Tabelleninhalte geschrieben; info.txt wird automatisch erzeugt.',
        ...
        checkRawAudiosMissing: 'Keine Audio-Dateien erkannt',
        checkInfoTxtAuto: 'info.txt wird automatisch erzeugt',
        titleDe: 'Titel (DE)',
        titleEn: 'Titel (EN)',
        ...
        audioTracksHint: 'Setze pro Audio-Stream Titel, Typ, Standardlautstärke und optional ein Icon.',
        ...
        rawAudioMetaHint: 'Setze pro Audio-Datei Titel, Typ, Standardlautstärke und optional ein Icon. Diese Angaben landen in der info.txt.',
        audioTitleDe: 'Audio-Titel (DE)',
        audioTitleEn: 'Audio-Titel (EN)',
        localizedAudioTitle: 'Audio-Titel',
        audioTypeDe: 'Audio-Typ (DE)',
        audioTypeEn: 'Audio-Typ (EN)',
        localizedAudioType: 'Audio-Typ',
