const enPages = {
    ...
    videoManagement: {
        ...
        mediaFolderHintDetailed: 'Hint: Files in the selected folder should be HLS/video assets (e.g. .m3u8, .ts, .mp4). Maximum file size depends on the storage bucket limit.',
        ...
        audioTracksHint: 'Set what each audio track contains and the default volume.',
        rawVideoFile: 'Video file',
        rawVideoFileHint: 'Allowed formats: .mp4, .mov, .mkv, .webm, .m4v. Maximum 300 MiB (target: HD, 30fps, up to 5 minutes).',
        ...
        rawVideoAudioMetaRequired: 'Please describe what the embedded video-audio track contains.',
        rawThumbnailFile: 'Thumbnail file',
        rawThumbnailFileHint: 'Allowed formats: .png, .jpg, .jpeg, .webp, .gif, .avif. Maximum 20 MiB. Optional.',
        rawAudioFiles: 'Audio files',
        rawAudioPickerHint: 'Select one audio file per field. Click "Add another audio" for more files or use the automatically added next field.',
        rawAudioMinRequired: 'Please provide at least {{count}} audio files.',
        rawAudioFileLabel: 'Audio file {{index}}',
        rawAudioFileHint: 'Allowed formats: .aiff, .aif, .wav, .mp3, .aac, .flac, .m4a, .ogg. Maximum 64 MiB per file.',
        addAudioFileAction: 'Add another audio',
        removeAudioFileAction: 'Remove audio',
        rawAudioMetaTitle: 'Configure audio files',
        rawAudioMetaHint: 'Set what each audio file contains and the default volume.',
        rawAudioMetaComplete: 'Audio metadata complete.',
        rawAudioMetaRequired: 'Please describe what each selected audio file contains.',
        audioContentDe: 'What does this audio track contain? (DE)',
        audioContentEn: 'What does this audio track contain? (EN)',
        localizedAudioContent: 'What does this audio track contain? (e.g. background music or voice)',
